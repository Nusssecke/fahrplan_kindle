...
class FBInkState:
    def __init__(self):
        self._fbink_state = ffi.new("FBInkState *")

    def to_c(self):
        return self._fbink_state

    @property
    def user_hz(self) -> int:
        """:return: USER_HZ (should pretty much always be 100)"""
        return self._fbink_state.user_hz

    @user_hz.setter
    def user_hz(self, value: int):
        """:param value: USER_HZ (should pretty much always be 100)"""
        self._fbink_state.user_hz = value

    @property
    def font_name(self) -> str:
        """:return: fbink_cfg->fontname (c.f., fontname_to_string())"""
        return self._fbink_state.font_name

    @font_name.setter
    def font_name(self, value: str):
        """:param value: fbink_cfg->fontname (c.f., fontname_to_string())"""
        self._fbink_state.font_name = value

    @property
    def view_width(self) -> int:
        """:return: viewWidth (MAY be different than screen_width on devices with a viewport)"""
        return self._fbink_state.view_width

    @view_width.setter
    def view_width(self, value: int):
        """:param value: viewWidth (MAY be different than screen_width on devices with a viewport)"""
        self._fbink_state.view_width = value

    @property
    def view_height(self) -> int:
        """:return: viewHeight (ditto)"""
        return self._fbink_state.view_height

    @view_height.setter
    def view_height(self, value: int):
        """:param value: viewHeight (ditto)"""
        self._fbink_state.view_height = value

    @property
    def screen_width(self) -> int:
        """:return: screenWidth (Effective width, c.f., is_ntx_quirky_landscape & initialize_fbink())"""
        return self._fbink_state.screen_width

    @screen_width.setter
    def screen_width(self, value: int):
        """:param value: screenWidth (Effective width, c.f., is_ntx_quirky_landscape & initialize_fbink())"""
        self._fbink_state.screen_width = value

    @property
    def screen_height(self) -> int:
        """:return: screenHeight (ditto)"""
        return self._fbink_state.screen_height

    @screen_height.setter
    def screen_height(self, value: int):
        """:param value: screenHeight (ditto)"""
        self._fbink_state.screen_height = value

    @property
    def scanline_stride(self) -> int:
        """:return: fInfo.line_length (scanline length in bytes, padding included)"""
        return self._fbink_state.scanline_stride

    @scanline_stride.setter
    def scanline_stride(self, value: int):
        """:param value: fInfo.line_length (scanline length in bytes, padding included)"""
        self._fbink_state.scanline_stride = value

    @property
    def bpp(self) -> int:
        """:return: vInfo.bits_per_pixel"""
        return self._fbink_state.bpp

    @bpp.setter
    def bpp(self, value: int):
        """:param value: vInfo.bits_per_pixel"""
        self._fbink_state.bpp = value

    @property
    def inverted_grayscale(self) -> bool:
        """:return: true if vInfo.grayscale is set to GRAYSCALE_8BIT_INVERTED (@ 8bpp)"""
        return self._fbink_state.inverted_grayscale

    @inverted_grayscale.setter
    def inverted_grayscale(self, value: bool):
        """:param value: true if vInfo.grayscale is set to GRAYSCALE_8BIT_INVERTED (@ 8bpp)"""
        self._fbink_state.inverted_grayscale = value

    @property
    def device_name(self) -> str:
        """:return: deviceQuirks.deviceName (short common name, no brand)"""
        return self._fbink_state.device_name

    @device_name.setter
    def device_name(self, value: str):
        """:param value: deviceQuirks.deviceName (short common name, no brand)"""
        self._fbink_state.device_name = value

    @property
    def device_codename(self) -> str:
        """:return: deviceQuirks.deviceCodename"""
        return self._fbink_state.device_codename

    @device_codename.setter
    def device_codename(self, value: str):
        """:param value: deviceQuirks.deviceCodename"""
        self._fbink_state.device_codename = value

    @property
    def device_platform(self) -> str:
        """:return: deviceQuirks.devicePlatform (often a codename, too)"""
        return self._fbink_state.device_platform

    @device_platform.setter
    def device_platform(self, value: str):
        """:param value: deviceQuirks.devicePlatform (often a codename, too)"""
        self._fbink_state.device_platform = value

    @property
    def device_id(self) -> DEVICE_ID:
        """:return: deviceQuirks.deviceId (decimal value, c.f., identify_device() on Kindle!)"""
        return self._fbink_state.device_id

    @device_id.setter
    def device_id(self, value: DEVICE_ID):
        """:param value: deviceQuirks.deviceId (decimal value, c.f., identify_device() on Kindle!)"""
        self._fbink_state.device_id = value

    @property
    def pen_fg_color(self) -> int:
        """:return: penFGColor (Actual grayscale value, not FG_COLOR_INDEX_E)"""
        return self._fbink_state.pen_fg_color

    @pen_fg_color.setter
    def pen_fg_color(self, value: int):
        """:param value: penFGColor (Actual grayscale value, not FG_COLOR_INDEX_E)"""
        self._fbink_state.pen_fg_color = value

    @property
    def pen_bg_color(self) -> int:
        """:return: penBGColor (ditto)"""
        return self._fbink_state.pen_bg_color

    @pen_bg_color.setter
    def pen_bg_color(self, value: int):
        """:param value: penBGColor (ditto)"""
        self._fbink_state.pen_bg_color = value

    @property
    def screen_dpi(self) -> int:
        """:return: deviceQuirks.screenDPI"""
        return self._fbink_state.screen_dpi

    @screen_dpi.setter
    def screen_dpi(self, value: int):
        """:param value: deviceQuirks.screenDPI"""
        self._fbink_state.screen_dpi = value

    @property
    def font_w(self) -> int:
        """:return: FONTW (effective width of a glyph cell, i.e. scaled)"""
        return self._fbink_state.font_w

    @font_w.setter
    def font_w(self, value: int):
        """:param value: FONTW (effective width of a glyph cell, i.e. scaled)"""
        self._fbink_state.font_w = value

    @property
    def font_h(self) -> int:
        """:return: FONTH (effective height of a glyph cell, i.e. scaled)"""
        return self._fbink_state.font_h

    @font_h.setter
    def font_h(self, value: int):
        """:param value: FONTH (effective height of a glyph cell, i.e. scaled)"""
        self._fbink_state.font_h = value

    @property
    def max_cols(self) -> int:
        """:return: MAXCOLS (at current cell size)"""
        return self._fbink_state.max_cols

    @max_cols.setter
    def max_cols(self, value: int):
        """:param value: MAXCOLS (at current cell size)"""
        self._fbink_state.max_cols = value

    @property
    def max_rows(self) -> int:
        """:return: MAXROWS (ditto)"""
        return self._fbink_state.max_rows

    @max_rows.setter
    def max_rows(self, value: int):
        """:param value: MAXROWS (ditto)"""
        self._fbink_state.max_rows = value

    @property
    def view_hori_origin(self) -> int:
        """:return: viewHoriOrigin (would be non-zero on devices with a horizontal viewport)"""
        return self._fbink_state.view_hori_origin

    @view_hori_origin.setter
    def view_hori_origin(self, value: int):
        """:param value: viewHoriOrigin (would be non-zero on devices with a horizontal viewport)"""
        self._fbink_state.view_hori_origin = value

    @property
    def view_vert_origin(self) -> int:
        """:return: viewVertOrigin (origin in px of row 0, includes viewport + viewVertOffset)"""
        return self._fbink_state.view_vert_origin

    @view_vert_origin.setter
    def view_vert_origin(self, value: int):
        """:param value: viewVertOrigin (origin in px of row 0, includes viewport + viewVertOffset)"""
        self._fbink_state.view_vert_origin = value

    @property
    def view_vert_offset(self) -> int:
        """:return: viewVertOffset (shift in px needed to vertically balance rows over viewHeight)"""
        return self._fbink_state.view_vert_offset

    @view_vert_offset.setter
    def view_vert_offset(self, value: int):
        """:param value: viewVertOffset (shift in px needed to vertically balance rows over viewHeight)"""
        self._fbink_state.view_vert_offset = value

    @property
    def fontsize_mult(self) -> int:
        """:return: FONTSIZE_MULT (current cell scaling multiplier)"""
        return self._fbink_state.fontsize_mult

    @fontsize_mult.setter
    def fontsize_mult(self, value: int):
        """:param value: FONTSIZE_MULT (current cell scaling multiplier)"""
        self._fbink_state.fontsize_mult = value

    @property
    def glyph_width(self) -> int:
        """:return: glyphWidth (native width of a glyph cell, i.e. unscaled)"""
        return self._fbink_state.glyph_width

    @glyph_width.setter
    def glyph_width(self, value: int):
        """:param value: glyphWidth (native width of a glyph cell, i.e. unscaled)"""
        self._fbink_state.glyph_width = value

    @property
    def glyph_height(self) -> int:
        """:return: glyphHeight (native height of a glyph cell, i.e. unscaled)"""
        return self._fbink_state.glyph_height

    @glyph_height.setter
    def glyph_height(self, value: int):
        """:param value: glyphHeight (native height of a glyph cell, i.e. unscaled)"""
        self._fbink_state.glyph_height = value

    @property
    def is_perfect_fit(self) -> bool:
        """:return: deviceQuirks.isPerfectFit (horizontal column balance is perfect over viewWidth)"""
        return self._fbink_state.is_perfect_fit

    @is_perfect_fit.setter
    def is_perfect_fit(self, value: bool):
        """:param value: deviceQuirks.isPerfectFit (horizontal column balance is perfect over viewWidth)"""
        self._fbink_state.is_perfect_fit = value

    @property
    def is_sunxi(self) -> bool:
        """:return: deviceQuirks.isSunxi (device is running on an AllWinner SoC)"""
        return self._fbink_state.is_sunxi

    @is_sunxi.setter
    def is_sunxi(self, value: bool):
        """:param value: deviceQuirks.isSunxi (device is running on an AllWinner SoC)"""
        self._fbink_state.is_sunxi = value

    @property
    def sunxi_has_fbdamage(self) -> bool:
        """:return: sunxiCtx.has_fbdamage (true when fbdamage module is loaded)"""
        return self._fbink_state.sunxi_has_fbdamage

    @sunxi_has_fbdamage.setter
    def sunxi_has_fbdamage(self, value: bool):
        """:param value: sunxiCtx.has_fbdamage (true when fbdamage module is loaded)"""
        self._fbink_state.sunxi_has_fbdamage = value

    @property
    def sunxi_force_rota(self) -> SUNXI_FORCE_ROTA_INDEX:
        """:return: sunxiCtx.force_rota (current effective value)"""
        return self._fbink_state.sunxi_force_rota

    @sunxi_force_rota.setter
    def sunxi_force_rota(self, value: SUNXI_FORCE_ROTA_INDEX):
        """:param value: sunxiCtx.force_rota (current effective value)"""
        self._fbink_state.sunxi_force_rota = value

    @property
    def is_kindle_legacy(self) -> bool:
        """:return: deviceQuirks.isKindleLegacy (device is a Kindle using the original einkfb EPDC API)"""
        return self._fbink_state.is_kindle_legacy

    @is_kindle_legacy.setter
    def is_kindle_legacy(self, value: bool):
        """:param value: deviceQuirks.isKindleLegacy (device is a Kindle using the original einkfb EPDC API)"""
        self._fbink_state.is_kindle_legacy = value

    @property
    def is_kindle_mtk(self) -> bool:
        """:return: deviceQuirks.isKindleMTK (device is a Kindle running on a MediatTek SoC)"""
        return self._fbink_state.is_kindle_mtk

    @is_kindle_mtk.setter
    def is_kindle_mtk(self, value: bool):
        """:param value: deviceQuirks.isKindleMTK (device is a Kindle running on a MediatTek SoC)"""
        self._fbink_state.is_kindle_mtk = value

    @property
    def is_kobo_non_mt(self) -> bool:
        """:return: deviceQuirks.isKoboNonMT (device is a Kobo with no MultiTouch input support)"""
        return self._fbink_state.is_kobo_non_mt

    @is_kobo_non_mt.setter
    def is_kobo_non_mt(self, value: bool):
        """:param value: deviceQuirks.isKoboNonMT (device is a Kobo with no MultiTouch input support)"""
        self._fbink_state.is_kobo_non_mt = value

    @property
    def ntx_boot_rota(self) -> int:
        """:return: deviceQuirks.ntxBootRota (Native rotation at boot)"""
        return self._fbink_state.ntx_boot_rota

    @ntx_boot_rota.setter
    def ntx_boot_rota(self, value: int):
        """:param value: deviceQuirks.ntxBootRota (Native rotation at boot)"""
        self._fbink_state.ntx_boot_rota = value

    @property
    def ntx_rota_quirk(self) -> NTX_ROTA_INDEX:
        """:return: deviceQuirks.ntxRotaQuirk (c.f., utils/dump.c)"""
        return self._fbink_state.ntx_rota_quirk

    @ntx_rota_quirk.setter
    def ntx_rota_quirk(self, value: NTX_ROTA_INDEX):
        """:param value: deviceQuirks.ntxRotaQuirk (c.f., utils/dump.c)"""
        self._fbink_state.ntx_rota_quirk = value

    @property
    def is_ntx_quirky_landscape(self) -> bool:
        """:return: deviceQuirks.isNTX16bLandscape (rotation compensation is in effect)"""
        return self._fbink_state.is_ntx_quirky_landscape

    @is_ntx_quirky_landscape.setter
    def is_ntx_quirky_landscape(self, value: bool):
        """:param value: deviceQuirks.isNTX16bLandscape (rotation compensation is in effect)"""
        self._fbink_state.is_ntx_quirky_landscape = value

    @property
    def current_rota(self) -> int:
        """:return: vInfo.rotate (current native rotation, c.f., <linux/fb.h>)"""
        return self._fbink_state.current_rota

    @current_rota.setter
    def current_rota(self, value: int):
        """:param value: vInfo.rotate (current native rotation, c.f., <linux/fb.h>)"""
        self._fbink_state.current_rota = value

    @property
    def can_rotate(self) -> bool:
        """:return: deviceQuirks.canRotate (device has a gyro)"""
        return self._fbink_state.can_rotate

    @can_rotate.setter
    def can_rotate(self, value: bool):
        """:param value: deviceQuirks.canRotate (device has a gyro)"""
        self._fbink_state.can_rotate = value

    @property
    def can_hw_invert(self) -> bool:
        """:return: deviceQuirks.canHWInvert (device can use EPDC inversion)"""
        return self._fbink_state.can_hw_invert

    @can_hw_invert.setter
    def can_hw_invert(self, value: bool):
        """:param value: deviceQuirks.canHWInvert (device can use EPDC inversion)"""
        self._fbink_state.can_hw_invert = value

    @property
    def has_eclipse_wfm(self) -> bool:
        """:return: deviceQuirks.hasEclipseWfm (device can use nightmode waveform modes)"""
        return self._fbink_state.has_eclipse_wfm

    @has_eclipse_wfm.setter
    def has_eclipse_wfm(self, value: bool):
        """:param value: deviceQuirks.hasEclipseWfm (device can use nightmode waveform modes)"""
        self._fbink_state.has_eclipse_wfm = value
...
class FBInkConfig:
    ...
    @property
    def col(self) -> int:
        """:return: x axis (i.e., column), counts down from the right edge of the screen if negative"""
        return self._fbink_cfg.col

    @col.setter
    def col(self, value: int):
        """:param value: x axis (i.e., column), counts down from the right edge of the screen if negative"""
        self._fbink_cfg.col = value

    @property
    def fontmult(self) -> int:
        """:return: Font scaling multiplier (i.e., 4 -> x4), 0 means automatic."""
        return self._fbink_cfg.fontmult

    @fontmult.setter
    def fontmult(self, value: int):
        """:param value: Font scaling multiplier (i.e., 4 -> x4), 0 means automatic."""
        self._fbink_cfg.fontmult = value

    @property
    def fontname(self) -> FONT_INDEX:
        """:return: Request a specific bundled font"""
        return self._fbink_cfg.fontname

    @fontname.setter
    def fontname(self, value: FONT_INDEX):
        """:param value: Request a specific bundled font"""
        self._fbink_cfg.fontname = value

    @property
    def is_inverted(self) -> bool:
        """:return: Invert colors."""
        return self._fbink_cfg.is_inverted

    @is_inverted.setter
    def is_inverted(self, value: bool):
        """:param value: Invert colors."""
        self._fbink_cfg.is_inverted = value

    #               This is *NOT* mutually exclusive with is_nightmode, and is *always* supported.
    @property
    def is_flashing(self) -> bool:
        """:return: Request a black flash on refresh (e.g., UPDATE_MODE_FULL instead of PARTIAL)"""
        return self._fbink_cfg.is_flashing

    @is_flashing.setter
    def is_flashing(self, value: bool):
        """:param value: Request a black flash on refresh (e.g., UPDATE_MODE_FULL instead of PARTIAL)"""
        self._fbink_cfg.is_flashing = value

    @property
    def is_cleared(self) -> bool:
        """:return: Clear the full screen beforehand (honors bg_color & is_inverted)"""
        return self._fbink_cfg.is_cleared

    @is_cleared.setter
    def is_cleared(self, value: bool):
        """:param value: Clear the full screen beforehand (honors bg_color & is_inverted)"""
        self._fbink_cfg.is_cleared = value

    @property
    def is_centered(self) -> bool:
        """:return: Center the text (horizontally)"""
        return self._fbink_cfg.is_centered

    @is_centered.setter
    def is_centered(self, value: bool):
        """:param value: Center the text (horizontally)"""
        self._fbink_cfg.is_centered = value

    @property
    def hoffset(self) -> int:
        """:return: Horizontal offset (in pixels) for text position"""
        return self._fbink_cfg.hoffset

    @hoffset.setter
    def hoffset(self, value: int):
        """:param value: Horizontal offset (in pixels) for text position"""
        self._fbink_cfg.hoffset = value

    @property
    def voffset(self) -> int:
        """:return: Vertical offset (in pixels) for text position"""
        return self._fbink_cfg.voffset

    @voffset.setter
    def voffset(self, value: int):
        """:param value: Vertical offset (in pixels) for text position"""
        self._fbink_cfg.voffset = value

    @property
    def is_halfway(self) -> bool:
        """:return: Vertically center the text, honoring row offsets"""
        return self._fbink_cfg.is_halfway

    @is_halfway.setter
    def is_halfway(self, value: bool):
        """:param value: Vertically center the text, honoring row offsets"""
        self._fbink_cfg.is_halfway = value

    @property
    def is_padded(self) -> bool:
        """:return: Pad the text with blanks (on the left, or on both sides if is_centered)"""
        return self._fbink_cfg.is_padded

    @is_padded.setter
    def is_padded(self, value: bool):
        """:param value: Pad the text with blanks (on the left, or on both sides if is_centered)"""
        self._fbink_cfg.is_padded = value

    @property
    def is_rpadded(self) -> bool:
        """:return: Right pad the text with blanks"""
        return self._fbink_cfg.is_rpadded

    @is_rpadded.setter
    def is_rpadded(self, value: bool):
        """:param value: Right pad the text with blanks"""
        self._fbink_cfg.is_rpadded = value

    @property
    def fg_color(self) -> FG_COLOR_INDEX:
        """:return: Requested foreground color for text (palette index)"""
        return self._fbink_cfg.fg_color

    @fg_color.setter
    def fg_color(self, value: FG_COLOR_INDEX):
        """:param value: Requested foreground color for text (palette index)"""
        self._fbink_cfg.fg_color = value

    @property
    def bg_color(self) -> BG_COLOR_INDEX:
        """:return: Requested background color for text (palette index)"""
        return self._fbink_cfg.bg_color

    @bg_color.setter
    def bg_color(self, value: BG_COLOR_INDEX):
        """:param value: Requested background color for text (palette index)"""
        self._fbink_cfg.bg_color = value

    @property
    def is_overlay(self) -> bool:
        """:return: Don't draw bg and use inverse of fb's underlying pixel as pen fg color"""
        return self._fbink_cfg.is_overlay

    @is_overlay.setter
    def is_overlay(self, value: bool):
        """:param value: Don't draw bg and use inverse of fb's underlying pixel as pen fg color"""
        self._fbink_cfg.is_overlay = value

    @property
    def is_bgless(self) -> bool:
        """:return: Don't draw bg (mutually exclusive with is_overlay, which will take precedence)"""
        return self._fbink_cfg.is_bgless

    @is_bgless.setter
    def is_bgless(self, value: bool):
        """:param value: Don't draw bg (mutually exclusive with is_overlay, which will take precedence)"""
        self._fbink_cfg.is_bgless = value

    @property
    def is_fgless(self) -> bool:
        """:return: Don't draw fg (takes precendence over is_overlay/is_bgless)"""
        return self._fbink_cfg.is_fgless

    @is_fgless.setter
    def is_fgless(self, value: bool):
        """:param value: Don't draw fg (takes precendence over is_overlay/is_bgless)"""
        self._fbink_cfg.is_fgless = value

    @property
    def no_viewport(self) -> bool:
        """:return: Ignore viewport corrections, whether hardware-related on Kobo, or to center rows"""
        return self._fbink_cfg.no_viewport

    @no_viewport.setter
    def no_viewport(self, value: bool):
        """:param value: Ignore viewport corrections, whether hardware-related on Kobo, or to center rows"""
        self._fbink_cfg.no_viewport = value

    @property
    def is_verbose(self) -> bool:
        """:return: Print verbose diagnostic informations on stdout"""
        return self._fbink_cfg.is_verbose

    @is_verbose.setter
    def is_verbose(self, value: bool):
        """:param value: Print verbose diagnostic informations on stdout"""
        self._fbink_cfg.is_verbose = value

    @property
    def is_quiet(self) -> bool:
        """:return: Hide fbink_init()'s hardware setup info (sent to stderr)"""
        return self._fbink_cfg.is_quiet

    @is_quiet.setter
    def is_quiet(self, value: bool):
        """:param value: Hide fbink_init()'s hardware setup info (sent to stderr)"""
        self._fbink_cfg.is_quiet = value

    @property
    def ignore_alpha(self) -> bool:
        """:return: Ignore any potential alpha channel in source image (i.e., flatten the image)"""
        return self._fbink_cfg.ignore_alpha

    @ignore_alpha.setter
    def ignore_alpha(self, value: bool):
        """:param value: Ignore any potential alpha channel in source image (i.e., flatten the image)"""
        self._fbink_cfg.ignore_alpha = value

    @property
    def halign(self) -> ALIGN_INDEX:
        """:return: Horizontal alignment of images/dumps"""
        return self._fbink_cfg.halign

    @halign.setter
    def halign(self, value: ALIGN_INDEX):
        """:param value: Horizontal alignment of images/dumps"""
        self._fbink_cfg.halign = value

    @property
    def valign(self) -> ALIGN_INDEX:
        """:return: Vertical alignment of images/dumps"""
        return self._fbink_cfg.valign

    @valign.setter
    def valign(self, value: ALIGN_INDEX):
        """:param value: Vertical alignment of images/dumps"""
        self._fbink_cfg.valign = value

    @property
    def scaled_width(self) -> int:
        """:return: Output width of images/dumps (0 for no scaling, -1 for viewport width)"""
        return self._fbink_cfg.scaled_width

    @scaled_width.setter
    def scaled_width(self, value: int):
        """:param value: Output width of images/dumps (0 for no scaling, -1 for viewport width)"""
        self._fbink_cfg.scaled_width = value

    @property
    def scaled_height(self) -> int:
        """:return: Output height of images/dumps (0 for no scaling, -1 for viewport height)"""
        return self._fbink_cfg.scaled_height

    @scaled_height.setter
    def scaled_height(self, value: int):
        """:param value: Output height of images/dumps (0 for no scaling, -1 for viewport height)"""
        self._fbink_cfg.scaled_height = value
    ...
    @property
    def wfm_mode(self) -> WFM_MODE_INDEX:
        """:return: Request a specific waveform mode (defaults to AUTO)"""
        return self._fbink_cfg.wfm_mode

    @wfm_mode.setter
    def wfm_mode(self, value: WFM_MODE_INDEX):
        """:param value: Request a specific waveform mode (defaults to AUTO)"""
        self._fbink_cfg.wfm_mode = value

    @property
    def dithering_mode(self) -> HW_DITHER_INDEX:
        """:return: Request a specific dithering mode (defaults to PASSTHROUGH)"""
        return self._fbink_cfg.dithering_mode

    @dithering_mode.setter
    def dithering_mode(self, value: HW_DITHER_INDEX):
        """:param value: Request a specific dithering mode (defaults to PASSTHROUGH)"""
        self._fbink_cfg.dithering_mode = value

    @property
    def sw_dithering(self) -> bool:
        """:return: Request (ordered) *software* dithering when printing an image."""
        return self._fbink_cfg.sw_dithering

    @sw_dithering.setter
    def sw_dithering(self, value: bool):
        """:param value: Request (ordered) *software* dithering when printing an image."""
        self._fbink_cfg.sw_dithering = value

    #                                      This is *NOT* mutually exclusive with dithering_mode!
    @property
    def is_nightmode(self) -> bool:
        """:return: Request hardware inversion (via EPDC_FLAG_ENABLE_INVERSION, if supported/safe)."""
        return self._fbink_cfg.is_nightmode

    @is_nightmode.setter
    def is_nightmode(self, value: bool):
        """:param value: Request hardware inversion (via EPDC_FLAG_ENABLE_INVERSION, if supported/safe)."""
        self._fbink_cfg.is_nightmode = value
    ...
    def no_refresh(self) -> bool:
        """:return: Skip actually refreshing the eInk screen (useful when drawing in batches)"""
        return self._fbink_cfg.no_refresh

    @no_refresh.setter
    def no_refresh(self, value: bool):
        """:param value: Skip actually refreshing the eInk screen (useful when drawing in batches)"""
        self._fbink_cfg.no_refresh = value

    @property
    def no_merge(self) -> bool:
        """:return: Set the EINK_NO_MERGE flag (Kobo sunxi only)"""
        return self._fbink_cfg.no_merge

    @no_merge.setter
    def no_merge(self, value: bool):
        """:param value: Set the EINK_NO_MERGE flag (Kobo sunxi only)"""
        self._fbink_cfg.no_merge = value

    @property
    def is_animated(self) -> bool:
        """:return: Enable refresh animation, following fbink_mtk_set_swipe_data (Kindle MTK only)"""
        return self._fbink_cfg.is_animated

    @is_animated.setter
    def is_animated(self, value: bool):
        """:param value: Enable refresh animation, following fbink_mtk_set_swipe_data (Kindle MTK only)"""
        self._fbink_cfg.is_animated = value

    @property
    def to_syslog(self) -> bool:
        """:return: Send messages & errors to the syslog instead of stdout/stderr"""
        return self._fbink_cfg.to_syslog

    @to_syslog.setter
    def to_syslog(self, value: bool):
        """:param value: Send messages & errors to the syslog instead of stdout/stderr"""
        self._fbink_cfg.to_syslog = value


class FBInkMargin:
    top: int  # Top margin in pixels (if negative, counts backwards from the bottom edge)
    bottom: int  # Bottom margin in pixels (supports negative values, too)
    left: int  # Left margin in pixels (if negative, counts backwards from the right edge)
    right: int  # Right margin in pixels (supports negative values, too)
...
class FBInkOTConfig:
    ...
    def __init__(self):
        self._fbink_ot_config = ffi.new("FBInkOTConfig *")

    def to_c(self):
        return self._fbink_ot_config

    @property
    def margins(self) -> FBInkMargin:
        """:return: argins: FBInkMargins"""
        return self._fbink_ot_config.margins

    @margins.setter
    def margins(self, value: FBInkMargin):
        """:param value: argins: FBInkMargins"""
        self._fbink_ot_config.margins = value

    @property
    def style(self) -> FONT_STYLE:
        """:return: Default font style to use when !is_formatted (defaults to Regular)"""
        return self._fbink_ot_config.style

    @style.setter
    def style(self, value: FONT_STYLE):
        """:param value: Default font style to use when !is_formatted (defaults to Regular)"""
        self._fbink_ot_config.style = value

    @property
    def size_pt(self) -> float:
        """:return: Size of text in points. If not set (0.0f), defaults to 12pt"""
        return self._fbink_ot_config.size_pt

    @size_pt.setter
    def size_pt(self, value: float):
        """:param value: Size of text in points. If not set (0.0f), defaults to 12pt"""
        self._fbink_ot_config.size_pt = value

    @property
    def size_px(self) -> int:
        """:return: Size of text in pixels. Optional, but takes precedence over size_pt."""
        return self._fbink_ot_config.size_px

    @size_px.setter
    def size_px(self, value: int):
        """:param value: Size of text in pixels. Optional, but takes precedence over size_pt."""
        self._fbink_ot_config.size_px = value

    @property
    def is_centered(self) -> bool:
        """:return: Horizontal centering"""
        return self._fbink_ot_config.is_centered

    @is_centered.setter
    def is_centered(self, value: bool):
        """:param value: Horizontal centering"""
        self._fbink_ot_config.is_centered = value

    @property
    def padding(self) -> PADDING_INDEX:
        """:return: Pad the drawing area (i.e., paint it in the background color)."""
        return self._fbink_ot_config.padding

    @padding.setter
    def padding(self, value: PADDING_INDEX):
        """:param value: Pad the drawing area (i.e., paint it in the background color)."""
        self._fbink_ot_config.padding = value
    ...
    def is_formatted(self) -> bool:
        """:return: Is string "formatted"? Bold/Italic support only, markdown like syntax"""
        return self._fbink_ot_config.is_formatted

    @is_formatted.setter
    def is_formatted(self, value: bool):
        """:param value: Is string "formatted"? Bold/Italic support only, markdown like syntax"""
        self._fbink_ot_config.is_formatted = value

    @property
    def compute_only(self) -> bool:
        """:return: Abort early after the line-break computation pass (no actual rendering)."""
        return self._fbink_ot_config.compute_only

    @compute_only.setter
    def compute_only(self, value: bool):
        """:param value: Abort early after the line-break computation pass (no actual rendering)."""
        self._fbink_ot_config.compute_only = value
    ...
    @property
    def no_truncation(self) -> bool:
        """:return: Abort as early as possible (but not necessarily before the rendering pass),
                    if the string cannot fit in the available area at the current font size."""
        return self._fbink_ot_config.no_truncation

    @no_truncation.setter
    def no_truncation(self, value: bool):
        """:param value: Abort as early as possible (but not necessarily before the rendering pass),
                        if the string cannot fit in the available area at the current font size."""
        self._fbink_ot_config.no_truncation = value
...
class FBInkOTFit:
    def __init__(self):
        self._fbink_ot_fit = ffi.new("FBInkOTConfig *")

    def to_c(self):
        return self._fbink_ot_fit

    @property
    def computed_lines(self) -> int:
        """:return: Expected amount of lines needed, according to font metrics."""
        return self._fbink_ot_fit.computed_lines

    @computed_lines.setter
    def computed_lines(self, value: int):
        """:param value: Expected amount of lines needed, according to font metrics."""
        self._fbink_ot_fit.computed_lines = value

    @property
    def rendered_lines(self) -> int:
        """:return: Actually rendered amount of lines."""
        return self._fbink_ot_fit.rendered_lines

    @rendered_lines.setter
    def rendered_lines(self, value: int):
        """:param value: Actually rendered amount of lines."""
        self._fbink_ot_fit.rendered_lines = value
    ...
    def truncated(self) -> bool:
        """:return: true if the string was truncated (at computation or rendering time)."""
        return self._fbink_ot_fit.truncated

    @truncated.setter
    def truncated(self, value: bool):
        """:param value: true if the string was truncated (at computation or rendering time)."""
        self._fbink_ot_fit.truncated = value


# This maps to a mxcfb rectangle, used for fbink_get_last_rect, as well as in FBInkDump
# NOTE: Unlike a mxcfb rectangle, left (x) comes *before* top (y)!
class FBInkRect:
    def __init__(self):
        self._fbink_rect = ffi.new("FBInkRect *")

    def to_c(self):
        return self._fbink_rect

    @property
    def left(self) -> int:
        """:return: x"""
        return self._fbink_rect.left

    @left.setter
    def left(self, value: int):
        """:param value: x"""
        self._fbink_rect.left = value

    @property
    def top(self) -> int:
        """:return: y"""
        return self._fbink_rect.top

    @top.setter
    def top(self, value: int):
        """:param value: y"""
        self._fbink_rect.top = value

    @property
    def width(self) -> int:
        return self._fbink_rect.width

    @width.setter
    def width(self, value: int):
        self._fbink_rect.width = value

    @property
    def height(self) -> int:
        return self._fbink_rect.height

    @height.setter
    def height(self, value: int):
        self._fbink_rect.height = value


# For use with fbink_dump & fbink_restore
class FBInkDump:
    def __init__(self):
        self._fbink_dump = ffi.new("FBInkDump *")

    def to_c(self):
        return self._fbink_dump

    @property
    def data(self) -> str:
        """:return: a"""
        return self._fbink_dump.data

    @data.setter
    def data(self, value: str):
        """:param value: a"""
        self._fbink_dump.data = value

    @property
    def stride(self) -> int:
        return self._fbink_dump.stride

    @stride.setter
    def stride(self, value: int):
        self._fbink_dump.stride = value

    @property
    def size(self) -> int:
        return self._fbink_dump.size

    @size.setter
    def size(self, value: int):
        self._fbink_dump.size = value

    @property
    def area(self) -> FBInkRect:
        return self._fbink_dump.area

    @area.setter
    def area(self, value: FBInkRect):
        self._fbink_dump.area = value

    @property
    def clip(self) -> FBInkRect:
        """:return: Only restore this rectangular area of the screen (has to intersect w/ the dump's area)"""
        return self._fbink_dump.clip

    @clip.setter
    def clip(self, value: FBInkRect):
        """:param value: Only restore this rectangular area of the screen (has to intersect w/ the dump's area)"""
        self._fbink_dump.clip = value

    @property
    def rota(self) -> int:
        return self._fbink_dump.rota

    @rota.setter
    def rota(self, value: int):
        self._fbink_dump.rota = value

    @property
    def bpp(self) -> int:
        return self._fbink_dump.bpp

    @bpp.setter
    def bpp(self, value: int):
        self._fbink_dump.bpp = value

    @property
    def is_full(self) -> bool:
        return self._fbink_dump.is_full

    @is_full.setter
    def is_full(self, value: bool):
        self._fbink_dump.is_full = value
...
def fbink_state_dump(fbink_cfg: FBInkConfig):
    ...
    """
    FBInk.fbink_state_dump(fbink_cfg.to_c())
...
def fbink_get_state(fbink_cfg: FBInkConfig, fbink_state: FBInkState):
    ...
    """
    FBInk.fbink_get_state(fbink_cfg.to_c(), fbink_state.to_c())
...
def fbink_print(fbfd: int, string: str, fbink_cfg: FBInkConfig) -> int:
    ...
    """
    return FBInk.fbink_print(fbfd, bytes(string, encoding='utf8'), fbink_cfg.to_c())
...
def fbink_add_ot_font(filename: str, style: FONT_STYLE) -> int:
    ...
    """
    return FBInk.fbink_add_ot_font(bytes(filename, encoding='utf8'), style)
...
def fbink_add_ot_font_v2(filename: str, style: FONT_STYLE, cfg: FBInkOTConfig) -> int:
    ...
    """
    return FBInk.fbink_add_ot_font_v2(bytes(filename, encoding='utf8'), style, cfg.to_c())
...
def fbink_free_ot_fonts_v2(cfg: FBInkOTConfig) -> int:
    ...
    """
    return FBInk.fbink_free_ot_fonts_v2(cfg.to_c())
...
def fbink_print_ot(fbfd: int, string: str, cfg: FBInkOTConfig, fbink_cfg: FBInkConfig, fit: FBInkOTFit) -> int:
    ...
    return FBInk.fbink_print_ot(fbfd, bytes(string, encoding='utf8'), cfg.to_c(), fbink_cfg.to_c(), fit)
...
def fbink_printf(fbfd: int, cfg: FBInkOTConfig, fbink_cfg: FBInkConfig, fmt: str, *args) -> int:
    ...
    """
    return FBInk.fbink_printf(fbfd, cfg.to_c(), fbink_cfg.to_c(), bytes(fmt, encoding='utf8'))
...
def fbink_refresh(fbfd: int, region_top: int, region_left: int, region_width: int, region_height: int,
    ...
    """
    return FBInk.fbink_refresh(fbfd, region_top, region_left, region_width, region_height, fbink_cfg.to_c())
...
def fbink_wait_for_complete(fbfd: int, marker: int) -> int:
    ...
    NOTE:   Waiting for a random marker *should* simply return early.
    """
    return FBInk.fbink_wait_for_complete(fbfd, marker)
...
def fbink_reinit(fbfd: int, fbink_cfg: FBInkConfig) -> int:
    ...
    :param fbink_cfg:   Pointer to an FBInkConfig struct.
    """
    return FBInk.fbink_reinit(fbfd, fbink_cfg.to_c())
...
def fbink_update_verbosity(fbink_cfg: FBInkConfig):
    ...
    """
    return FBInk.fbink_update_verbosity(fbink_cfg.to_c())
...
def fbink_update_pen_colors(fbink_cfg: FBInkConfig) -> int:
    ...
    """
    return FBInk.fbink_update_pen_colors(fbink_cfg.to_c())
...
def fbink_print_progress_bar(fbfd: int, percentage: int, fbink_cfg: FBInkConfig) -> int:
    ...
    """
    return FBInk.fbink_print_progress_bar(fbfd, percentage, fbink_cfg.to_c())
...
def fbink_print_activity_bar(fbfd: int, progress: int, fbink_cfg: FBInkConfig) -> int:
    ...
    @param fbink_cfg:	Pointer to an FBInkConfig struct (ignores is_overlay, is_fgless, col & hoffset;
                        as well as is_centered & is_padded).
    """
    return FBInk.fbink_print_activity_bar(fbfd, progress, fbink_cfg.to_c())
...
def fbink_print_image(fbfd: int, filename: str, x_off: int, y_off: int, fbink_cfg: FBInkConfig) -> int:
    ...
    """
    return FBInk.fbink_print_image(fbfd, bytes(filename, encoding='utf8'), x_off, y_off, fbink_cfg.to_c())


def fbink_print_raw_data(fbfd: int, data: bytes, w: int, h: int, len, x_off: int, y_off: int,
                         fbink_cfg: FBInkConfig) -> int:
    """
    ...
    """
    return FBInk.fbink_print_raw_data(fbfd, data, w, h, len, x_off, y_off, fbink_cfg.to_c())
...
def fbink_grid_clear(fbfd: int, cols: int, rows: int, fbink_cfg: FBInkConfig) -> int:
    ...
    """
    return FBInk.fbink_grid_clear(fbfd, cols, rows, fbink_cfg.to_c())
...
def fbink_grid_refresh(fbfd: int, cols: int, rows: int, fbink_cfg: FBInkConfig) -> int:
    ...
    NOTE: This *ignores* no_refresh ;).
    """
    return FBInk.fbink_grid_refresh(fbfd, cols, rows, fbink_cfg.to_c())
...
def fbink_dump(fbfd: int, dump: FBInkDump) -> int:
    ...
    NOTE:   On Kobo devices with a sunxi SoC, you will not be able to capture content that you haven't drawn yourself first.
            (There's no "shared" framebuffer, each process gets its own private, zero-initialized (i.e., solid black) buffer).
    """
    return FBInk.fbink_dump(fbfd, dump.to_c())
...
def fbink_region_dump(fbfd: int, x_off: int, y_off: int, w: int, h: int, fbink_cfg: FBInkConfig,
    ...
    """
    return FBInk.fbink_region_dump(fbfd, x_off, y_off, w, h, fbink_cfg.to_c(), dump.to_c())
...
def fbink_rect_dump(fbfd: int, rect: FBInkRect, dump: FBInkDump) -> int:
    ...
    NOTE: The same considerations as in fbink_dump should be taken regarding the handling of FBInkDump structs.
    """
    return FBInk.fbink_rect_dump(fbfd, rect.to_c(), dump.to_c())
...
def fbink_restore(fbfd: int, fbink_cfg: FBInkConfig, dump: FBInkDump) -> int:
    ...
    """
    return FBInk.fbink_restore(fbfd, fbink_cfg.to_c(), dump.to_c())
...
def fbink_free_dump_data(dump: FBInkDump) -> int:
    ...
    """
    return FBInk.fbink_free_dump_data(dump.to_c())
...
def fbink_invert_screen(fbfd: int, fbink_cfg: FBInkConfig) -> int:
    ...
    """
    return FBInk.fbink_invert_screen(fbfd, fbink_cfg.to_c())
