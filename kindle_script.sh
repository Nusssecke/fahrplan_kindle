...
# Kindle User: root; Password: minecraft

# Setup kindle network
# sudo ifconfig enxee4900000000 192.168.15.201
# Kindle ssh:
# sshpass -p "minecraft" ssh root@192.168.15.244
...
sshpass -p "minecraft" ssh root@192.168.15.244 "sh /mnt/base-us/extensions/fahrplan_kindle/bin/start_once.sh"
exit